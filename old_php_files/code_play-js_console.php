<?php
    $assignmentName = "Codeplay - JS Console";
    $assignmentId = "codeplay";

?>

<h2>
    Assignment: Code Play - JS Console
</h2>

<p id="codeplay">
    Output from Google Chrome JS console: <a href="../assignments/codeplayjs.txt" target="_blank">Codeplayjs.txt</a>
</p>


<pre class="scroll_pane"><code>console.log("Hello Alex");
